...
(function (win, $) {
    ...
    Search.prototype = {
        ...
        bindEvent: function () {
            ...
            that.dom.timeli.on("click",function(){
                if(!$(this).hasClass("selected") && !$(this).hasClass("indent")){
                    $(this).addClass("selected");
                    if(that.dom.selectDom){
                        that.dom.selectDom.removeClass("selected");
                    }
                    that.dom.selectDom = $(this);
                }
            });

            that.dom.nextBtn.on("click",function(){
                win.location = "../../pages/address/index.html"
            })
