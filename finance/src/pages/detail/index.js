        ...
        getList : function(){
            ...
            function callback(data){
                ...
                if(data.success && data.code == "1"){
                    ...
                    if(that.data.pageSize == data.data.length){
                        //@TODO 下一页
                        that.bindMore(true);
                    }
            ...
            Wlib.GetJsonData("http://121.199.57.142:8081/lifefinancial/api/news/getNewsCommentList.json?newsId="+that.data.newsId+"&pageIndex="+that.data.pageIndex+"&pageSize="+that.data.pageSize,callback,callback);
        },
        bindMore : function(tag){
            var that = this;
